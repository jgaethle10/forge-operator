...
COPY --from=build /app/systemia/chum/intent-language.mjs ./systemia/chum/intent-language.mjs
...
COPY --from=build /app/systemia/chum/owned-offer-door.mjs ./systemia/chum/owned-offer-door.mjs
