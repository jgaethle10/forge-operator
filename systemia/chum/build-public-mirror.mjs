...
const publicIndexHtml = [
  ...
  '<p><a href="/.well-known/evercraft-pain-index.json">Pain Index JSON</a> · <a href="/chum/pain-index.txt">Pain Index text</a> · <a href="/chum/answers/">Answer Graph</a> · <a href="/chum/answers/observed/">Observed discovery repairs</a> · <a href="/chum/hot/">Hot discovery queue</a> · <a href="/chum/strike/">Adaptive strike hub</a> · <a href="/chum/crawler-radar.json">Crawler radar</a> · <a href="/chum/pickup-radar.json">Pickup radar</a> · <a href="/llms-full.txt">LLM directory</a> · <a href="/openapi.json">OpenAPI</a> · <a href="/chum/revenue.html">Current sell-now offers</a></p>',
...
const sitemapStatic = [
  ...
  '/chum/pickup-radar.json',
  '/chum/pickup-radar.txt',
  '/chum/freshness.xml',
  '/chum/freshness.json',
...
const llmsLines = [
  ...
  `Pickup radar: ${rawBase}/public/chum/pickup-radar.json`,
