...
const llmsLines = [
  ...
  `Machine Commerce MCP (Official Registry remote): ${universalMcp || 'not declared'}`,
  `Redundant commerce MCP: ${safePublicUrl(catalog.universal_front_door?.redundant_edge_mcp, null) || 'not declared'}`,
...
const agentDirectory = {
  ...
  universal_front_door: {
    ...
    redundant_edge_mcp: safePublicUrl(catalog.universal_front_door?.redundant_edge_mcp, null),
