...
<link rel="canonical" href="${discovery.mirror.page_path}">
...
<div class="card"><h2>Machine doors</h2><p><a href="./llms.txt">llms.txt</a><br><a href="./ai-discovery.json">AI discovery JSON</a><br><a href="./ai-conformance.json">AI conformance JSON</a>${discovery.mcp ? `<br><a href="${escapeHtml(discovery.mcp)}">Remote MCP</a>` : ''}</p></div>
<p><a href="${escapeHtml(product.canonical_url)}">Open the canonical product or public capability</a></p>
<p class="muted">Discovery creates no payment obligation. Commercial continuation remains bounded by the published authority, confirmation and payment rules.</p>
</body>
</html>
`;
