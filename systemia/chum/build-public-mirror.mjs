...
const sitemapStatic = [
  ...
  '/.well-known/evercraft-agent-commerce.json',
  '/chum/agent-commerce.json',
  '/chum/agent-commerce.txt',
  '/chum/agent-commerce.html',
...
const discoveryWatershed = {
  ...
  start_here: {
    ...
    agent_commerce: '/.well-known/evercraft-agent-commerce.json',
    agent_commerce_text: '/chum/agent-commerce.txt',
    agent_commerce_html: '/chum/agent-commerce.html',
