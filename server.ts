...
app.get('/robots.txt', (req: Request, res: Response) => {
  ...
  res.type('text/plain').send(`# Evercraft public AI/search discovery policy.
# Public commercial surfaces are discoverable. Private/admin/action surfaces remain dark.
...
app.get('/api/discovery', (_req: Request, res: Response) => {
  res.json({
    ...
    public: {
      ...
      agent: '/.well-known/evercraft-agent.json',
      agentDirectory: '/.well-known/evercraft-agent-directory.json',
