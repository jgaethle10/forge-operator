...
const chumDirectory = JSON.parse(fs.readFileSync(path.resolve(__dirname,'public','.well-known','evercraft-products.json'),'utf8'));
const chumCatalog = JSON.parse(fs.readFileSync(path.resolve(__dirname,'registry','catalog.json'),'utf8'));
const chumOffers = JSON.parse(fs.readFileSync(path.resolve(__dirname,'public','.well-known','evercraft-offers.json'),'utf8'));
